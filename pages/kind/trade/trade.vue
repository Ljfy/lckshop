<template>
	<view class="product-main">
		<view class="tab head-bar">
			<view class="per" v-for="(item,index) in headItems" :class="{'active':index==current}" @tap="headChange(index,item)"
			 :key="index">
				{{item.name}}
		...
		<view class="product-list" >
			...
			<navigator class="product-block" :url="`../../info/info?proId=${item.id}`" :key="item.id" v-for="item in productList">
				...
				<view class="text-area">
					...
					<text class="price">¥{{item.price || 'more'}}</text>
